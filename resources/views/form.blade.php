            ...
            <div class="col-md-12">
                ...
                <form action="/stepform" method="POST" enctype="multipart/form-data" class="step-form needs-validation" novalidate>
                    ...
                    <div class="form-section">
                        <h4 class="text-center pt-4 mb-3" style="font-family: 'Mitr',
                        sans-serif">โปรดอ่านให้ละเอียดก่อนเสนอโครงการ</h4>
                        <div class="condi-le">
                            <div class="condi1">
                    ...
                    <div class="form-section col-12 mt-4 pt-4 pb-4" style="border-radius: 5px;">
                        ...
                        <div class="row justify-content-center bg-white rounded p-5">
                            <div class="box-section">
                                <label>ชื่อโครงการ</label>
                                <input type="text" id="validationCustom03" class="form-control"
                                       placeholder="ระบุชื่อ" name="projectname" required value="กองทุนพัฒนาชีวิตคนพิการ">
                                ...
                                <input type="text" id="validationCustom03" class="form-control"
                                       ...
                                       value="ดึงดูดต่อผู้คนที่ผ่านเข้ามาหรือมาใช้งานท่าเรือสี่พระยาอย่างแน่นอนซึ่งจะมีส่วนช่วยธุรกิจท้องถิ่นในบริเวณนี้" required>
                                <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" placeholder="ระบุเบอร์โทรศัพท์"
                                               name="tel" id="validationCustom03" value="0928256043" required>
                                    </div>
                                    <div class="invalid-feedback">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" placeholder="ระบุอีเมล" name="email"
                                               id="validationCustom03" value="chanok@gmail.com" required>
                                    </div>
                                    <div class="invalid-feedback">
                                        โปรดระบุอีเมล
                                    </div>
...
{{--                                </div>--}}
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file" id='eviimg'>
                                </div>
                    ...
                    <div class="form-section col-12 pt-4 pb-4" style="border-radius: 5px;">
                        ...
                        <div class="row justify-content-center bg-white rounded p-5">
                            <div class="box-section">
                                ...
                                <div class="border rounded bg-light p-4 bor" id='pjimg'>
                    ...
                    <div class="form-section col-12 pt-4 pb-4" style="border-radius: 5px;">
                        ...
                        <div class="row justify-content-center bg-white rounded p-5">
                            <div class="box-section">
                                ...
                                <input type="text" class="form-control" placeholder="ระบุเลขที่บัญชี" name="numberbank"
                                ...
                                <label class="mt-3">หมายเลขพร้อมเพย์</label>
...
{{--                                <input type="submit" class="btn btn-md btn-block btn-danger" value="Decode the Code">--}}
                    ...
                    <div class="form-navigation">
                        ...
                        <button type="button" class="next btn float-right mt-2">ต่อไป</button>
                        <button type="submit" class="btn btn-success float-right
                        mt-2">เสร็จสิ้น</button>
                    </div>
                </form>
            </div>
        </div>
