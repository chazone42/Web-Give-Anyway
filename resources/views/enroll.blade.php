            ...
            <div class="row justify-content-center col-sm-10">
                <div class="col-md-10">
                    ...
                    needs-validation" novalidate>
                        ...
                        <div class="form-group">
                            <input class="btn-enroll mb-3 mt-3 pt-1 pl-5 pb-1 pr-5"
                                   value="ยืนยันตัวตน" id="btn-confirm" type="button">
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <span>โปรดตรวจสอบให้ถูกต้องและครบถ้วนก่อนทำการยืนยันตัวตน</span>
                                    </div>
                                    <div class="modal-footer">
                                        <button class="btn btn-default" type="button" id="modal-btn-no">ยกเลิก</button>
                                        <button class="btn-enroll mb-3 mt-3 pt-1 pl-5 pb-1 pr-5"
                                                id="modal-btn-si" name="submit" type="submit">ยืนยัน</button>
                                    </div>
                                </div>
                            </div>
                        </div>
